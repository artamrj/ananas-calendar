  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-orange-50 to-yellow-100 p-4 sm:p-6 lg:p-8">
      <div className="w-full max-w-3xl space-y-6">
        <h1 className="text-center text-orange-600 drop-shadow-lg mb-8 text-6xl font-extrabold">
          Ananas <span className="text-2xl font-medium text-gray-700 ml-4">| Peel, paste, plan—Ananas style!</span>
        </h1>
